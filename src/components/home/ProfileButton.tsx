...
export function ProfileButton({ lang, dictionary }: ProfileButtonProps) {
  ...
  return (
    <Button 
      size="lg" 
      variant="outline" 
      className="rounded-full border-2 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 transition-all px-8 py-6 text-lg group border-emerald-200 dark:border-emerald-800" 
      asChild
    >
